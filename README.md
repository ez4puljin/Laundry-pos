...
> 🔐 **Лиценз:** Шинэ компьютерт суулгахдаа ашиглах хугацаа (туршилтын
> хоног эсвэл бүрэн эрх) сонгож, мастер нууц үгээр баталгаажуулна.
> Дэлгэрэнгүйг [LICENSING.md](LICENSING.md) -ээс үзнэ үү.

---

## ⚡ Шинэ компьютерт суулгах
...
`install.bat` бүх зүйлийг өөрөө хийнэ:

| Алхам | Хийх зүйл |
|---|---|
| 1 | **Python + Node.js** — байхгүй бол winget-ээр татаж суулгана (нэг удаа админ эрх асууна) |
| 2 | Backend — Python venv, багцууд, `.env` ба санамсаргүй нууц түлхүүр |
| 3 | Frontend — `npm install` |
| 4 | Mobile — Expo багцууд |
| 5 | Лиценз — ашиглах хугацаа сонгож, мастер нууц үгээр нээх |

**SQLite тусад нь суулгах шаардлагагүй** — Python дотор багтсан байдаг.
Мэдээллийн сан анх ажиллуулахад автоматаар үүсч, үндсэн өгөгдлөөр дүүрнэ.

Шаардлагатай зүйл: интернэт холболт, Windows 10/11.
